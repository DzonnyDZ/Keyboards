...
cli::array<Vk2WChar^>^ KbdTables::Vk2WChars::get(){
    INITARRAY(vk2WChars, kbdTables->pVkToWcharTable, Vk2WChar^, (InitArrayUntilZero<VK_TO_WCHAR_TABLE, Vk2WChar>(kbdTables->pVkToWcharTable))) 
        return vk2WChars;
}
